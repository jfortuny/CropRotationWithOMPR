...
The spreadsheet must have at least three tabs renamed with the labels listed; without them the data import will fail.

### Farmland

The **Farmland** tab identifies the **Fields** in the **Farm** by name, their _Measure_ and how much land is _Available_, and whether or not they should be _Included_ in the rotation.
